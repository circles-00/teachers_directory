...
export const SchoolShowcase: FC<SchoolShowcaseProps> = () => {
  return (
    <div className="mt-28 h-full bg-[url('/schools_showcase_bg.png')] bg-cover bg-center bg-no-repeat px-8 py-20 text-white md:px-44">
      ...
      <p className="mt-12 w-full text-xl font-bold md:w-1/2">
